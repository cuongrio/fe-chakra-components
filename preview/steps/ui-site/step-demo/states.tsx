import { Button, Flex, Heading, HStack, Radio, RadioGroup, VStack } from '@chakra-ui/react';
  ...
  return (
    <Flex flexDir='column' width='100%'>
      <VStack width='100%' mb={8} align='flex-start'>
        <RadioGroup defaultValue='loading' onChange={(val) => setStepState(val as StateValue)}>
