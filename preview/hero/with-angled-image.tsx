...
const HeroWithAngledImage = () => {
  const bg = useColorModeValue('white', 'gray.800');
  return (
    <Box pos='relative' overflow='hidden' bg={bg} mt={10} rounded='lg' boxShadow='rgba(0, 0, 0, 0.1) 0px 4px 12px;'>
...
export default HeroWithAngledImage;
