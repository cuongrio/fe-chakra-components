import { Box, Button, Center, chakra, Flex, GridItem, Icon, Input, SimpleGrid, VisuallyHidden } from '@chakra-ui/react';

const HeroKuttySignupForm = () => {
  return (
    <Box px={8} py={24} mx='auto' rounded='lg' boxShadow='rgba(0, 0, 0, 0.1) 0px 4px 12px;'>
      <SimpleGrid
        alignItems='center'
      ...
      >
        ...
        <GridItem colSpan={{ base: 'auto', md: 4 }}>
          ...
          <chakra.p fontSize='xs' textAlign='center' color='gray.600'>
            By signing up you agree to our <chakra.a color='blue.500'>Terms of Service</chakra.a>
          </chakra.p>
        </GridItem>
      </SimpleGrid>
    </Box>
...
export default HeroKuttySignupForm;
