...
const NavbarFullWidthFlyouts = () => {
  ...
  const ic = useColorModeValue('blue.600', 'blue.50');
  const hbg = useColorModeValue('gray.50', 'blue.400');
  const tcl = useColorModeValue('gray.900', 'gray.50');
  const dcl = useColorModeValue('gray.500', 'gray.50');
  const hbgh = useColorModeValue('gray.100', 'blue.500');
  ...
  return (
    <React.Fragment>
      <chakra.header p={10} h='full' bg={bg} w='full' px={{ base: 2, sm: 4 }} py={4}>
...
export default NavbarFullWidthFlyouts;
