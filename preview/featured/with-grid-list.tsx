...
const FeaturedWithGridList = () => {
  const Feature = (props) => {
    return (
      <Box>
        ...
        <chakra.h3 mb={2} fontWeight='semibold' lineHeight='shorter' _light={{ color: 'gray.900' }}>
          {props.title}
        </chakra.h3>
  ...
  return (
    <Flex w='auto' justifyContent='center' alignItems='center'>
      <Box px={8} py={20} mx='auto' bg='white' _dark={{ bg: 'gray.800' }}>
        <Box textAlign={{ lg: 'center' }}>
          ...
          <chakra.p mt={4} maxW='2xl' fontSize='xl' mx={{ lg: 'auto' }} color='gray.500' _dark={{ color: 'gray.400' }}>
        ...
        <SimpleGrid columns={{ base: 1, sm: 2, md: 3, lg: 4 }} spacingX={{ base: 16, lg: 24 }} spacingY={20} mt={6}>
          ...
          <Feature
            ...
            icon={
              <>
                <path xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' aria-hidden='true'>
...
export default FeaturedWithGridList;
