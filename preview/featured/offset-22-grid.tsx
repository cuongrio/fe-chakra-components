...
import { chakra, Box, Flex, Icon, SimpleGrid, Stack, GridItem } from '@chakra-ui/react';

const FeaturedOffset22Grid = () => {
  const Feature = (props) => {
    return (
      <Flex>
        <Flex shrink={0}>
        ...
        <Box ml={4}>
          <chakra.dt fontSize='lg' fontWeight='bold' lineHeight='6' _light={{ color: 'gray.900' }}>
            {props.title}
          </chakra.dt>
          ...
          <GridItem colSpan={2}>
            ...
            >
              ...
              <Feature title='Unify your payments stack'>
                Manage all your online and offline sales in one place with a single integration, simplifying reporting
                and reconciliation.
              </Feature>
              ...
              <Feature title='Decide how you integrate Payments'>
                {' '}
                Love to code? Decide how you integrate Payments and build advanced and reliable products yourself from
                scratch.{' '}
              </Feature>
            </Stack>
          </GridItem>
...
export default FeaturedOffset22Grid;
