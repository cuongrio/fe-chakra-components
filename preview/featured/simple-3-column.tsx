  ...
  const Feature = (props) => {
    return (
      <Box>
        ...
        <chakra.p lineHeight='tall' color='gray.600' _dark={{ color: 'gray.400' }}>
          {props.children}
        </chakra.p>
      </Box>
    );
  ...
  return (
    <Flex w='auto' justifyContent='center' alignItems='center'>
      ...
      >
        ...
        >
          Provide a seamless customer experience across channels, like reserving online and picking up in store. Our
          SDKs make it easy to integrate into your own mobile and web applications to accept in-store payments.
        </Feature>
...
export default FeaturedSimple3Column;
