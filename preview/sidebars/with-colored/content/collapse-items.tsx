...
import { Box, Button, ButtonProps, Collapse, Flex, Icon, IconProps, Text, useDisclosure } from '@chakra-ui/react';
...
const CollapseItems = ({ icon, items, title, px, py, textSize, textColor, bgColor, bgActiveColor }: Props) => {
  ...
  return (
    <>
      <Button variant='link' {...buttonProps} onClick={onToggle} cursor='pointer' borderRadius={0} fontWeight='normal'>
