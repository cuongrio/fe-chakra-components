...
const PricingThreeTierWithEmphasized = () => {
  const Feature = (props) => {
    return (
      <Flex alignSelf='start' w='full'>
        <Icon
          ...
          as={IoCheckmark}
        />
        <chakra.p fontSize='lg' color='gray.600' _dark={{ color: 'gray.400' }} {...props} />
      </Flex>
    );
  };
  return (
    <Flex bg='#edf3f8' _dark={{ bg: '#3e3e3e' }} p={10} rounded="lg" w='full' justifyContent='center' alignItems='center'>
      <Box w='full' pt={8}>
        <Flex direction={{ base: 'column', md: 'row' }} justifyContent='center' mb={{ base: 6, sm: 0 }}>
          <Flex
            ...
            direction='column'
          >
            <VStack spacing={1} justifyContent='center' p={8} textAlign='center' w='full' shadow='xl'>
              ...
              <HStack spacing={3}>
                ...
                <chakra.span alignSelf='center' fontSize='3xl' _light={{ color: 'gray.400' }}>
                  /month
                </chakra.span>
              </HStack>
            </VStack>
...
export default PricingThreeTierWithEmphasized;
