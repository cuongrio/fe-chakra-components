...
const CardArticle = () => {
  return (
    <Flex p={4} w='full' alignItems='center'>
      <Box mx='auto' px={8} py={4} rounded='lg' shadow='lg' bg='white' _dark={{ bg: 'gray.800' }} maxW='2xl'>
        ...
        <Flex justifyContent='space-between' alignItems='center' mt={4}>
          <Link color='blue.600' _dark={{ color: 'blue.400' }} _hover={{ textDecor: 'underline' }}>
            Read more
          </Link>
          ...
          <Flex alignItems='center'>
            <Image
              ...
              alt='avatar'
            />
            <Link color='gray.700' _dark={{ color: 'gray.200' }} fontWeight='700' cursor='pointer'>
              Khatab wedaa
            </Link>
          </Flex>
        </Flex>
