  ...
  return (
    <Flex p={4} w='full' alignItems='center'>
      ...
      >
        ...
        <Box gridColumn='span 8' p={8} width='full' height='full' borderRadius='lg' textAlign='left' mt={10}>
          <Text fontSize='4xl' fontWeight='bold' color='gray.800' _dark={{ color: 'white' }}>
            Christian Buehner
          </Text>
          <HStack spacing={3} color='gray.800' _dark={{ color: 'gray.200' }}>
            <FaSuitcase size={24} />
            <Text fontSize='2xl' fontWeight='bold' color='gray.800' _dark={{ color: 'gray.200' }}>
              Photographer
            </Text>
          </HStack>
...
export default CardUserLessDetail;
